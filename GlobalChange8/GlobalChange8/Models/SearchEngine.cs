...
namespace GlobalChange8.Models
{
    ...
    public class SearchEngine
    {
        ...
        public SearchEngine()
        {
            ...
            //_apiClassNameMapping.Add("?", "RegisterRequest");
            //_apiClassNameMapping.Add("?", "RegisterResponse");
            _apiClassNameMapping.Add("RegistrationInfo", "RegistrationInfoResponse");
            _apiClassNameMapping.Add("ResetPassword", "ResetPasswordRequest");
            //_apiClassNameMapping.Add("?", "ResetPasswordResponse");
            _apiClassNameMapping.Add("WebsiteRequestActionDevice", "WebsiteDeviceActionRequest");
            _apiClassNameMapping.Add("WebsiteRequestActionResult", "WebsiteActionResponseItem");
            _apiClassNameMapping.Add("WebsiteRequestAction", "WebsiteActionRequest");
            //_apiClassNameMapping.Add("?", "WebsiteActionResponse");
            _apiClassNameMapping.Add("WebsiteRequestCategory", "WebsiteCategoryListResponse");
            _apiClassNameMapping.Add("WebsiteRequestDetails", "WebsiteRequestDetailsResponse");
            _apiClassNameMapping.Add("WebsiteRequestDevice", "WebsiteDeviceListResponse");
            _apiClassNameMapping.Add("WebsiteRequests", "WebsiteListResponse");
            _apiClassNameMapping.Add("WebsiteRequest", "WebsiteListResponseItem");
            //_apiClassNameMapping.Add("?", "WebsiteListRequest");
            Load();
        }
        #endregion
        ...
        public void Search()
        {
            ...
            if (_pathChanged)
            {
                _dir = new Dir();
                _dir.Action = _action;
                _dir.EventBeginProgress += new Models.EventDelegate(_dir_EventBeginProgress);
                _dir.EventUpdateProgress += new Models.EventDelegate(_dir_EventUpdateProgress);
                _dir.EventEndOfProgress += new Models.EventDelegate(_dir_EventEndOfProgress);
                ...
                if (File.Exists(fileSpec))
                {
                    ...
                    if (sr1.Peek() >= 0)
                    {
                        do
                        {
                            ...
                            if (line.StartsWith("*") && line.Contains("GCM payload should be in following format"))
                            {
