...
{
    /// <summary>
    /// Abstract directory listing class.
    /// </summary>
    /// <remarks>
    ...
    public abstract class DirectoryEngine
    {
        ...
        protected bool monitoredTypesOnly = false;
        protected DateTime dateThreshold = DateTime.MinValue;
        ...
        public abstract DirectoryEntries DirList(string qualifier, ref long estimate);
        ...
        /// <param name="estimate">Number of directory entries found. Used for future estimating.</param>
        public abstract void DirLevel(DirectoryEntry parentEntry, string qualifier, string directory, ref List<string> dirs, ref long estimate);
