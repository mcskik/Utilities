using Lookout.DataLayer.Tracing;
using System;
    ...
    public static class Administrator
    {
        ...
        public static Tracer Tracer
        {
            get
            {
                if (_tracer == null)
                {
                    _tracer = new Tracer(ProfileManager.SystemProfile.LogPath, "Lookout", DateTime.Now, "LKO", String.Format(@"Lookout ({0})", _profileManager.ApplicationProfile.Version), true, false);
                }
                return _tracer;
            }
        }
